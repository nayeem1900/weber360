        ...
        <div class="row">
            <div class="card" style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item"><a href="{{route('communityhospitalcommittee')}}">Community Hospital Committee</a></li>
                    <li class="list-group-item"><a href="{{route('educationcommittee')}}"> Education Committee</a></li>
                    <li class="list-group-item"><a href="{{route('educationcommittee')}}">Health Education Committee</a></li>
                </ul>
            </div>
            <div class="col-md-8">
